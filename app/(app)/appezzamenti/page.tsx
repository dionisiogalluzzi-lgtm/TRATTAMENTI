...
export default async function FieldsPage({ searchParams }: { searchParams: Promise<{ ok?: string; error?: string }> }) {
  ...
  return <>
    <PageHeader eyebrow="SUPERFICI" title="Appezzamenti e colture" description="La superficie anagrafica resta fissa; i cicli colturali conservano lo storico di coltura, varietà e fase fenologica." />
